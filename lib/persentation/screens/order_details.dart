                    ...
                    if(state is OrderDetailsLoaded){
                      ...
                      return Column(
                        children: [
                          ...
                          InkWell(
                            onTap: ()async{
                              String googleUrl = 'https://www.google.com/maps/search/?api=1&query=${order.branch!.lat},${order.branch!.long}';
                                  ...
                                  Row(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Padding(
                                        ...
                                        child: Text(order.paymentMethod!.title!.en.toString(), style:  TextStyle(fontSize:  size.width * .04, color:order.paymentMethodId ==1?Colors.red: Colors.green,height: size.height * .0015,)),
                                      ),
